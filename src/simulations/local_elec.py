...
class LocalElecEnv():
    ...
    def _check_constraints(
        ...
        # self.car.update_step(time_step=self.time, implement=False)
        # assert self.car.time_step == self.time, f"self.car.time_step {self.car.time_step} self.time {self.time}"
